...
const navigationCategories = [
  ...
  },
  {
    ...
    items: [
      { id: 'tutor', label: 'Arohi AI Tutor & Smart Board', icon: GraduationCap, color: 'text-emerald-400 bg-emerald-500/10 border-emerald-500/20', badge: 'Live Class' },
      { id: 'mocktests', label: 'All-India Mock Tests & CBT Exams', icon: Award, color: 'text-rose-400 bg-rose-500/10 border-rose-500/20', badge: 'Class 1-12 & Govt/Nursing' },
