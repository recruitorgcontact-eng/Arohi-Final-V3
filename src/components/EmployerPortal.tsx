...
export default function EmployerPortal({ 
  ...
  const [jobApplyLink, setJobApplyLink] = useState('https://arohiai.com/apply-now');
  ...
  const handlePostJobSubmit = (e: React.FormEvent) => {
    ...
    const newPosting: Posting = {
      ...
      links: {
        applyOnline: jobApplyLink || "https://arohiai.com/apply-now",
        officialWebsite: "https://arohiai.com"
      }
    };
  ...
  const simulateApplicantsForJob = () => {
    ...
    const simulatedCandidates: Application[] = [
      ...
      },
      {
        ...
        gender: 'Female',
        category: 'General',
        email: 'riya.patnaik@arohiai.com',
        phone: '9944112233',
      ...
      },
      {
        ...
        gender: 'Male',
        category: 'OBC',
        email: 'chandan.sahoo@arohiai.com',
        phone: '9438090122',
                ...
                {isMatchingLoading && (
                  <div className="flex-1 flex flex-col items-center justify-center space-y-4 py-16">
                    ...
                    <div className="text-center space-y-1">
                      ...
                      <p className="text-[10px] text-slate-500 font-bold">Scanning candidate profile against job spec via Arohi AI Engine</p>
                    </div>
                  </div>
                )}
