...
export function generateResumePDF() {
  try {
    ...
    y += 5;
    doc.setFont('Helvetica', 'normal');
    const proj2 = "Co-implemented a responsive WebSockets audio transmission stream using Arohi Live Voice API, streaming little-endian 16kHz PCM audio inputs and outputting real-time synthesized voice advisements.";
